import type * as FxAppliedCouponCode from "./applied_coupon_code";

export type Rel = "applied_coupon_codes";
export type Curie = "fx:applied_coupon_codes";
...
export interface Graph {
  ...
  links: Links;
  props: Props;
  child: FxAppliedCouponCode.Graph;
  zooms: Zooms;
}
