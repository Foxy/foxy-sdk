import type * as FxNativeIntegration from "./native_integration";

export type Rel = "native_integrations";
export type Curie = "fx:native_integrations";
...
export interface Graph {
  ...
  links: Links;
  props: Props;
  child: FxNativeIntegration.Graph;
  zooms: Zooms;
}
