import type { Constraints, NextDateRules, RuleSubject } from './types';

import { getTimeFromFrequency } from './getTimeFromFrequency.js';
import jsonata from 'jsonata';

export type { Constraints } from './types';
 ...
 */
export function getNextTransactionDateConstraints(data: RuleSubject, rules: NextDateRules): Constraints | boolean {
