import type * as FxCouponItemCategories from "./coupon_item_categories";
import type * as FxGenerateCodes from "./generate_codes";
...
export interface Links {
  ...
  "fx:coupon_codes": FxCouponCodes.Links;
  /** POST here to generate random coupon codes. */
  "fx:generate_codes": FxGenerateCodes.Links;
  /** Valid item categories for this coupon. */
  "fx:coupon_item_categories": FxCouponItemCategories.Links;
}
