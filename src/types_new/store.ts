...
export interface Links {
  ...
  "fx:item_categories": FxItemCategories.Links;
  /** List of fraud protection measures enabled on this store. */
  "fx:fraud_protections": FxFraudProtections.Links;
  ...
  "fx:subscription_settings": FxSubscriptionSettings.Links;
  ...
  "fx:customer_portal_settings": FxCustomerPortalSettings.Links;
  /** POST here to resend the daily subscription webhook notification for this store. */
  "fx:process_subscription_webhook": FxProcessSubscriptionWebhook.Links;
}
